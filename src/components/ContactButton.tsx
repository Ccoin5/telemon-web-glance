  ...
  return (
    <div className="w-full py-8 bg-blue-50">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-2xl font-bold mb-4 text-blue-800">Need assistance?</h2>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
          <Button asChild className="bg-blue-700 hover:bg-blue-800 text-white py-2 px-6 rounded-lg inline-flex items-center gap-2">
            <Link to="/contact">
